...
/**
 * Core spread index management, navigation callbacks, chapter reset/clamp/advance
 * effects, and TwoPageNav export for two-page reading mode.
 */
export function useSpreadNavigation(
